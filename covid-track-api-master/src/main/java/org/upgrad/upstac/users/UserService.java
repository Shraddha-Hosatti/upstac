...
public class UserService {
    ...
    public User addUserWithRole(@Valid RegisterRequest registerRequest, Role role, AccountStatus status) {
        ...
        String useBlockchain = "false"; // Change to env.getProperty("blockchain.use"); for adding user on blockchain for testing
        ...
        values.put("role", role.getName());
        values.put("firstName", registerRequest.getFirstName());
        values.put("lastName", registerRequest.getLastName());
        values.put("gender", registerRequest.getGender().name());
        values.put("dob", getDateFromString(registerRequest.getDateOfBirth()).format(DateTimeFormatter.ofPattern("dd/MM/yyyy")));
        values.put("phone", registerRequest.getPhoneNumber());
        values.put("email", registerRequest.getEmail());
        values.put("address", registerRequest.getAddress());
        values.put("pinCode", String.valueOf(registerRequest.getPinCode()));
    ...
    public User updateUserDetails(User user, UpdateUserDetailRequest updateUserDetailRequest) {
        ...
        String url = baseURL + "updateUserDetails";

        // Blockchain Request Body Parameters
        String newDetailsPayload = "";
        newDetailsPayload = newDetailsPayload + "{\"firstName\" :  \""+updateUserDetailRequest.getFirstName()+"\", ";
        newDetailsPayload = newDetailsPayload + "\"lastName\" :  \""+updateUserDetailRequest.getLastName()+"\", ";
        newDetailsPayload = newDetailsPayload + "\"email\" :  \""+updateUserDetailRequest.getEmail()+"\" }";
        HashMap values = new HashMap<String, String>();
        values.put("fabricUserName", fabricUserName);
        values.put("channelName", "common");
        values.put("chainCodeName", "common");
        values.put("smartContractName", "org.upstac.user");
        values.put("phone", updateUserDetailRequest.getPhoneNumber());
