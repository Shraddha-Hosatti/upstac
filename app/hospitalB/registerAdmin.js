...
async function main(certificatePath, privateKeyPath) {
    try {
        ...
        let caInfo = connectionProfile.certificateAuthorities['ca.hospitalB.upstac.com'];
        ...
        let identity = X509WalletMixin.createIdentity('hospitalBMSP', enrollment.certificate, enrollment.key.toBytes());
