...
async function main(certificatePath, privateKeyPath) {
    try {
        ...
        let caInfo = connectionProfile.certificateAuthorities['ca.hospitalA.upstac.com'];
        ...
        let identity = X509WalletMixin.createIdentity('hospitalAMSP', enrollment.certificate, enrollment.key.toBytes());
