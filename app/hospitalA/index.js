...
app.get('/', (req, res) => res.send('Hello HospitalA'));

app.post('/hospitalA/addToWallet', (req, res) => {
...
app.post('/hospitalA/registerUser', (req, res) => {
...
app.post('/hospitalA/registerAdmin', (req, res) => {
...
app.post('/hospitalA/revokeUser', (req, res) => {
...
app.post('/hospitalA/addNewUser',async (req, res) => {
...
app.post('/hospitalA/getUserDetails',async (req, res) => {
...
app.post('/hospitalA/updateUserDetails',async (req, res) => {
...
app.post('/hospitalA/addNewTest',async (req, res) => {
...
app.post('/hospitalA/updateTestDetails',async (req, res) => {
...
app.post('/hospitalA/getTestDetails',async (req, res) => {
...
app.post('/hospitalA/getPatientTestDetails',async (req, res) => {
...
app.post('/hospitalA/requestPrice',async (req, res) => {
...
app.post('/hospitalA/getAllPriceRequests',async (req, res) => {
...
app.post('/hospitalA/getPriceRequest',async (req, res) => {
...
app.post('/hospitalA/approvePriceRequest',async (req, res) => {
...
app.post('/hospitalA/getAllUsersData',async (req, res) => {
...
app.post('/hospitalA/getAllTestData',async (req, res) => {
